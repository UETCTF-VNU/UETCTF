...
{
    internal partial class GameChallengeEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            ...
            var difficulty = runtimeEntityType.AddProperty(
                "Difficulty",
                typeof(double),
                propertyInfo: typeof(GameChallenge).GetProperty("Difficulty", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(GameChallenge).GetField("<Difficulty>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                sentinel: 0.0);
            difficulty.TypeMapping = NpgsqlDoubleTypeMapping.Default.Clone(
            ...
            var enableTrafficCapture = runtimeEntityType.AddProperty(
                "EnableTrafficCapture",
                typeof(bool),
                propertyInfo: typeof(GameChallenge).GetProperty("EnableTrafficCapture", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(GameChallenge).GetField("<EnableTrafficCapture>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                sentinel: false);
            enableTrafficCapture.TypeMapping = NpgsqlBoolTypeMapping.Default.Clone(
                ...
                providerValueComparer: new ValueComparer<bool>(
                    ...
                    (bool v) => v.GetHashCode(),
                    (bool v) => v));
            enableTrafficCapture.AddAnnotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.None);
            ...
            var gameId = runtimeEntityType.AddProperty(
                "GameId",
                typeof(int),
                propertyInfo: typeof(GameChallenge).GetProperty("GameId", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(GameChallenge).GetField("<GameId>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                sentinel: 0);
            ...
            var minScoreRate = runtimeEntityType.AddProperty(
                "MinScoreRate",
                typeof(double),
                propertyInfo: typeof(GameChallenge).GetProperty("MinScoreRate", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(GameChallenge).GetField("<MinScoreRate>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                sentinel: 0.0);
            minScoreRate.TypeMapping = NpgsqlDoubleTypeMapping.Default.Clone(
                comparer: new ValueComparer<double>(
                    (double v1, double v2) => v1.Equals(v2),
                    (double v) => v.GetHashCode(),
                    (double v) => v),
                ...
                providerValueComparer: new ValueComparer<double>(
                    ...
                    (double v) => v.GetHashCode(),
                    (double v) => v));
            minScoreRate.AddAnnotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.None);

            var originalScore = runtimeEntityType.AddProperty(
                "OriginalScore",
                typeof(int),
                propertyInfo: typeof(GameChallenge).GetProperty("OriginalScore", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(GameChallenge).GetField("<OriginalScore>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                sentinel: 0);
            originalScore.TypeMapping = IntTypeMapping.Default.Clone(
                comparer: new ValueComparer<int>(
                    (int v1, int v2) => v1 == v2,
                    (int v) => v,
                    (int v) => v),
                ...
                mappingInfo: new RelationalTypeMappingInfo(
                    storeTypeName: "integer"));
            originalScore.AddAnnotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.None);
        ...
        public static RuntimeForeignKey CreateForeignKey2(RuntimeEntityType declaringEntityType, RuntimeEntityType principalEntityType)
        {
            ...
            var game = declaringEntityType.AddNavigation("Game",
                ...
                onDependent: true,
                typeof(Game),
                propertyInfo: typeof(GameChallenge).GetProperty("Game", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(GameChallenge).GetField("<Game>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly));

            var challenges = principalEntityType.AddNavigation("Challenges",
                runtimeForeignKey,
                onDependent: false,
                typeof(List<GameChallenge>),
                propertyInfo: typeof(Game).GetProperty("Challenges", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(Game).GetField("<Challenges>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly));
        ...
        public static RuntimeSkipNavigation CreateSkipNavigation1(RuntimeEntityType declaringEntityType, RuntimeEntityType targetEntityType, RuntimeEntityType joinEntityType)
        {
            var skipNavigation = declaringEntityType.AddSkipNavigation(
                ...
                joinEntityType.FindForeignKey(
                    new[] { joinEntityType.FindProperty("ChallengeId") },
                    declaringEntityType.FindKey(new[] { declaringEntityType.FindProperty("Id") }),
                    declaringEntityType),
                true,
                false,
                typeof(HashSet<Participation>),
                propertyInfo: typeof(GameChallenge).GetProperty("Teams", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(GameChallenge).GetField("<Teams>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly));

            var inverse = targetEntityType.FindSkipNavigation("Challenges");
            if (inverse != null)
            {
        ...
        public static void CreateAnnotations(RuntimeEntityType runtimeEntityType)
        {
            ...
            runtimeEntityType.AddAnnotation("Relational:TableName", "GameChallenges");
